...
<br>
    ...
    <div class="container" style="max-width: 100%;">
      ...
      <h1>Proses Workspace</h1>
      <br>
      <br>
      <div class="col-md-1" style=" margin-top: 12px; ">
      <img class="img-responsive" src="gambar/persiapan.png" style="max-width: 100px; max-height: 100px;">
    </div>
     <div class="col-md-1" style=" margin-top: 15px; max-width: 50px; max-height: 50px;"><img class="img-responsive" src="gambar/next.png" style=" margin: 20px 32px 20px 12px; ">
    </div>
    <div class="col-md-1" style=" margin-top: 12px; "><img class="img-responsive" src="gambar/pengerjaan.png" style="max-width: 100px; max-height: 100px;">
    </div>
    <div class="col-md-1" style=" margin-top: 15px; max-width: 50px; max-height: 50px;"><img class="img-responsive" src="gambar/next.png" style=" margin: 20px 32px 20px 12px; ">
    </div>
    <div class="col-md-1" style=" margin-top: 12px; "><img class="img-responsive" src="gambar/finishing1.png" style="max-width: 100px; max-height: 100px;">
    </div>
     <div class="col-md-1" style=" margin-top: 15px; max-width: 50px; max-height: 50px;"><img class="img-responsive" src="gambar/next.png" style=" margin: 20px 32px 20px 12px; ">
    </div>
    <div class="col" style=" margin-top: 12px; "><img class="img-responsive" src="gambar/selesai1.png" style="max-width: 100px; max-height: 100px;">
    </div>
    ...
    <div class="container" style="max-width: 100%;">
      ...
      <label for="comment"><h1>Obrolan:</h1></label>
      <textarea class="form-control" rows="12" id="Chat"></textarea>
      </div>
   <br>
      <div class="form-group">
    ...
    <button type="file" class="btn btn-file">Input File</button>
