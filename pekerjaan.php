...
<br>
    ...
    <div class="container" style="max-width: 100%;">
      ...
      <img class="img-responsive" src="img/persiapan.png" style="max-width: 100px; max-height: 100px;">
    </div>
     <div class="col-md-1" style=" margin-top: 15px; max-width: 50px; max-height: 50px;"><img class="img-responsive" src="img/next.png" style=" margin: 20px 32px 20px 12px; ">
    </div>
